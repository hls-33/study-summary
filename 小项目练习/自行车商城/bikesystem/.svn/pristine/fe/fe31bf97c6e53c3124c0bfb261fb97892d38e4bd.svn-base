  			 ...
  			 <div class="main-bottom">
  			 		...
  			 		<div>
  			 				<table>
  			 						...
  			 						<tbody>
  			 								<tr>
  			 										<th colspan="4"  class="main-bm-tr-th">店铺：<span>${requestScope.shopname }</span></th>	
  			 								</tr>
  			 								<tr class="main-bm-tt">
		  			 								<th><img alt="" src="${requestScope.imgpath }" style="width:50px;height:40px;"><span> ${requestScope.bikename}</span></th>
		...
		<script type="text/javascript">
						$(function(){
								$("#bottom-bt input[type='button']").click(function(){
											var bikeprice =$(".bottom-sp ul li span").text() ;
											var shopname =$(".main-bm-tr-th span").text();
											var name ="${sessionScope.user.name}";
											window.location.href="/bikesystem/hp/referto?bikeprice="+bikeprice+"&shopname="+shopname+"&name="+name+"";	
								});
								$(".addAddr").click(function(){
											window.location.href="/bikesystem/buyaddress.jsp";	
								});
