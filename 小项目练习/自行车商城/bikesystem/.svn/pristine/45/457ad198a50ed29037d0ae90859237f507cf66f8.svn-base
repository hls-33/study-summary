...
<body>
	...
	<div id="header" class="tm-chn">
		<div id="headerCon">
			<h1 id="mallLogo">
				<span class="mlogo"> <a href="index.jsp"
					title="天猫Tmall.com"><img class="web-logo" src="/bikesystem/image/hgg/logo.jpg"></a>
				</span>
			</h1>
			<div id="shopExtra">
				<div class="slogo">
			...
			<div id="input-sou">
				<input type="text" name="search" placeholder="请输入要搜索的词">
				<button>搜本店</button>
			</div>
		</div>
	</div>
