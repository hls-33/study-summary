...
public class QrcodeUtils {
    ...
    private BufferedImage qRCodeCommon(String content, String imgType, int size,String logopath) {  
        ...
        try {  
            ...
            int y1 = imgSize/3;
            int width = imgSize/3;
            int height = imgSize/3;   
            Image img = ImageIO.read(new File(logopath));  
            gs.drawImage(img, x1,y1,width,height, null);  
...
//    	String path = "e://二维码.png";
//    	String encorderContext = "http://hsadmin:8080/bikesystem/user/hs/codescanner?scanner=true&date="+new Date().getTime();
//    	QrcodeUtils qrcode = new QrcodeUtils();
//    	qrcode.encoderQRCode(encorderContext, path, "png",18,"e://logo.jpg");
//    	
