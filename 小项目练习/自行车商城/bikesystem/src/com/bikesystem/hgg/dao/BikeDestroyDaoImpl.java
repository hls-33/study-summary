...
public class BikeDestroyDaoImpl extends BaseDao implements IBikeDestroyDao {
	...
	private static final String queryAllBikeDestroySql="select * from bike_destroy where shopname=?";
	private static final String deleteBikeSql="delete from bike_rent where bikenumber=?";
