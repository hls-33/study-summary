...
<head lang="en">
	<title>收货地址</title>
	<script src="//g.alicdn.com/??kissy/k/1.4.7/seed-min.js,tb/global/3.3.35/global-min.js" type="text/javascript"></script>
</head>
<body><script>
with(document)with(body)with(insertBefore(createElement("script"),firstChild))setAttribute("exparams","category=&userid=2020578484&aplus&yunid=&51ee3eb75e7e3&trid=0b83e34a14939464986302444ef9b3&asid=AbSUb3iC0AtZRe44KQAAAABTQAhZ49jmUA==",id="tb-beacon-aplus",src=(location>"https"?"//g":"//g")+".alicdn.com/alilog/mlog/aplus_v2.js")
</script>

<div id="content">
	<div class="main-wrap">
		    <link href="//assets.alicdn.com/s/kissy/1.3.0/css/dpl/base-min.css" rel="stylesheet">
		<link href="//g.alicdn.com//tb/mbis/0.4.13/address/css/address.css?t=20150910" rel="stylesheet"/>
		<link href="//g.alicdn.com/tm/buy/1.0.10/mod/addrMaker.css" rel="stylesheet"/>
...
<div class="form-box" id="J_FormBox">
	<div id="mapContainer"></div>
			...
			<span class="item-label tsl" data-phase-id="d_p_addNewDeliverAddress" id="J_DeliverTitle">新增收货地址　</span><span class="tsl" data-phase-id="d_p_addNewDeliverAddressNotice">邮政编码选填, 其余均为必填项</span>
					</div>
		<form id="J_FormDeliver" action="/bikesystem/hp/address " method="post">
		<input type="hidden" name="action" value="DeliverAddressMgr"/>
		<input type="hidden" name="event_submit_do_save" value="anything"/>
			<input type="hidden" name="from" value="tmall"/>
		<input type="hidden" name="isFrame" value="true"/>
		<input type="hidden" name="token" value=""/>
		<input type="hidden" name ="lang" value="zh-S" id="J_lang"> 
		<input name='_tb_token_' type='hidden' value='51ee3eb75e7e3'>
		<input type="hidden" name="id" id="J_iId" value=""/>
			<input type="hidden" name="x" id="J_lat" value=""/>
			<input type="hidden" name="y" id="J_lng" value=""/>
		<input type="hidden" name="reurl" value="//buy.tmall.com/order/addressProxy.htm"/>
		...
		<div class="item item-devision" id="J_ItemDivision">
			...
			<div id="J_CitySelect" class="ks-clear clearfix">
				...
				<select class="J_Country" aria-label="请选择">
					<option class="tsl" data-phase-id="d_p_chooseStation" value="">请选择</option>
					<option class="tsl" data-phase-id="d_p_chinaInland" value="0"  selected >中国大陆</option>
					...
					<option class="tsl" data-phase-id="d_p_gangAoTai" value="1" >港澳</option>
					                    ...
					                    <option class="tsl" data-phase-id="d_p_foreignCountry" value="990000" >海外其他</option>
				</select>
										</div>
			<div class="msg-box">
		...
		<div class="item item-street" id="J_ItemStreet">
			...
			<div class="ks-combobox" id="J_ComboboxStreet" aria-pressed="false">
				<div class="ks-combobox-input-wrap">
					<textarea class="ks-combobox-input i-ta disabled tsl" aria-combobox="list" role="combobox" autocomplete="off" name="addressDetail" id="J_Street" aria-label="详细地址"
					          ...
					          data-ph="建议您如实填写详细收货地址，例如街道名称，门牌号码，楼层和房间号等信息" disabled="disabled"></textarea>
				</div>
			</div>
			<div class="msg-box">
		...
		<div class="item item-postcode" id="J_ItemPostCode">
			...
			<div class="item-warp">
			<input name="post" aria-label="邮政编码" maxlength=16 data-item="postcode" placeholder="如您不清楚邮递区号，请填写000000" data-inner_placeholder="d_p_input_inner_postCode" data-ph="如您不清楚邮递区号，请填写000000" data-pattern="^.{0,16}$" data-msg="d_p_postCode_msg" class="i-text tsl" id="J_PostCode" type="text" value="">
			</div>
		...
		<div class="item item-name" id="J_ItemName">
			...
			<div class="item-warp">
			<input name="fullName" class="i-text tsl" aria-label="收货人姓名" type="text" id="J_Name" placeholder="长度不超过25个字符" data-inner_placeholder="d_p_input_inner_fullName" data-pattern="^.{2,25}$" data-msg="d_p_fullName_msg"
			       data-ph="长度不超过25个字符"
			       value="">
			</div>
		...
		<div class="item item-mobile" id="J_ItemMobile">
			...
			<select name="mobile_area" id="J_MobileArea" aria-label="手机号码">
			...
			<div class="item-warp">
			<input name="mobile" class="i-text tsl" aria-label="手机号码" type="text" id="J_Mobile" placeholder="手机号码" data-inner_placeholder="d_p_input_inner_mobile" data-pattern="^\d{6,20}$" data-ph="电话号码、手机号码必须填一项"
		...
		</div><button type="submit" class=" btn  tsl" data-phase-id="d_p_saveSubmit" style="margin-left:60px;">保存</button>
...
<script type="text/javascript">
	window.CONFIG = {
		_tb_token_: "51ee3eb75e7e3",
		api: "//member1.taobao.com/member/fresh/deliver_address_editor_save_submit.do?_input_charset=UTF-8"
					,
			map: {
				mapType: 'trade',
				mapSize: {
	...
	window.CONSTANT = {
		...
		"ERROR_DELIVER_ADDRESS_REQUIRE_MOBILE_OR_PHONE": "手机号码必须要",
...
<script src="//webapi.amap.com/maps?v=1.3&key=4e84b3fa70fbdc218a1f944fafc129e7" language="javascript"></script>
<script src="//g.alicdn.com//vip/address/6.0.5/index-min.js" charset="UTF-8"></script>
<script src="//g.alicdn.com//tb/mbis/0.4.13/address/js/??taobao.js,address.js,index.js?t=20150910"></script>
<script language="javascript" type="text/javascript" src="/bikesystem/js/hp/jquery-3.2.0.js"></script>
				<script type="text/javascript">
						$(function(){
											var address = $("#citity-title").val();
											var minuteaddress=$(".ks-combobox-input-wrap").val();
											var  username = $("input[name='fullName']").val();
											var phone = $("input[name='moblie']").vai();
											alert(address+minuteaddress+username+phone);
